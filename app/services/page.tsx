  ...
  return (
    <div className="flex flex-col w-full">
      <section className="relative flex w-full h-[50vh]">
        <div className="z-10 absolute w-full h-full bg-gradient-to-r from-primary from-50% to-white/40 to-75%" />
        <div className="z-20 flex-1 flex justify-center items-center w-full h-full">
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-4 w-full max-w-2xl">
              <h1 className="text-2xl text-accent font-heading font-bold">
                Our Services
              </h1>
              <span className="w-1/8 h-1 bg-accent" />
              <h2 className="text-6xl text-white font-heading font-semibold">
                Lending solutions built for Niagara.
              </h2>
            </div>
            <p className="w-full max-w-md text-xl text-white">
      ...
      <section className="flex justify-center w-full min-h-[80vh]">
        <div className="flex flex-col w-full max-w-7xl my-20 px-12 py-8">
          <div className="flex flex-col gap-8 items-center">
            <h2 className="text-5xl text-primary font-heading font-bold">
              How We Help
            </h2>
            <span className="w-1/8 h-1 bg-accent" />
            <p className="max-w-2xl text-xl text-primary text-center">
          ...
          ultrices suscipit."
                ...
                icon={<HOME_ICON className="size-8" strokeColour="#c19d55" />}
              />
              <ServiceCard
                header="SERVICE 2"
                text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
          ...
          ultrices suscipit."
                ...
                icon={<TOOLS_ICON className="size-8" strokeColour="#c19d55" />}
              />
              <ServiceCard
                header="SERVICE 3"
                text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
          ...
          ultrices suscipit."
                ...
                icon={<CHART_ICON className="size-8" strokeColour="#c19d55" />}
              />
            </div>
          </div>
        </div>
      ...
      <section className="flex justify-center w-full">
        <div className="flex w-full max-w-7xl items-center px-8 gap-12">

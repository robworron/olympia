...
export default function NavMenu({ onClick }: NavMenuProps) {
  return (
    <nav
      className="absolute lg:hidden top-16 md:top-24 right-0 border-l border-b border-gray-200 rounded-bl-xl"
      aria-label="Main navigation"
    >
      <ul className="flex flex-col w-60 bg-white text-xl font-semibold font-heading rounded-bl-xl">
        <li className="group relative w-full p-8 border-b border-gray-200 transition-translate duration-200 hover:translate-x-2">
